...
- [run_pipeline.py](/home/user/ldl/molmospaces-exp-setting/scripts/datagen/run_pipeline.py:139)
  - `task_type == "nav_to_obj"` 时，使用 `NavToObjBaseConfig + AStarNavToObjPolicyConfig`
- [nav_task_sampler.py](/home/user/ldl/molmospaces-exp-setting/molmo_spaces/tasks/nav_task_sampler.py:38)
  - `init_scene()` 会先生成 occupancy map，并缓存到 `self._cached_thormap`
  - `_sample_task()` 会把这个 map 挂到 `task.occupancy_map`
- [astar_planner.py](/home/user/ldl/molmospaces-exp-setting/molmo_spaces/planner/astar_planner.py:28)
  - 把 occupancy map 下采样成 grid，再建 `networkx` graph 做图搜索
- [astar_planner_policy.py](/home/user/ldl/molmospaces-exp-setting/molmo_spaces/policy/solvers/navigation/astar_planner_policy.py:458)
  - 每 step 返回下一个 base waypoint

当前关键限制：

- [AStarPlanner.map](/home/user/ldl/molmospaces-exp-setting/molmo_spaces/planner/astar_planner.py:44) 默认按 `model_path` 重新生成 map
- 它不是直接消费运行时 `MjData`
...
见 [task_configs.py](/home/user/ldl/molmospaces-exp-setting/molmo_spaces/configs/task_configs.py:156)：
...
见 [task_configs.py](/home/user/ldl/molmospaces-exp-setting/molmo_spaces/configs/task_configs.py:127)：
...
见 [task_configs.py](/home/user/ldl/molmospaces-exp-setting/molmo_spaces/configs/task_configs.py:100)：
...
door 的专用接口在 [data_views.py](/home/user/ldl/molmospaces-exp-setting/molmo_spaces/env/data_views.py:605)：
...
通用接口来自 [MlSpacesArticulationObject](/home/user/ldl/molmospaces-exp-setting/molmo_spaces/env/data_views.py:500)：
...
- [cabinet.py](/home/user/ldl/molmospaces-exp-setting/molmo_spaces/env/arena/cabinet.py:1)
- [drawer.py](/home/user/ldl/molmospaces-exp-setting/molmo_spaces/env/arena/drawer.py:1)
...
- [mj_extensions.py](/home/user/ldl/molmospaces-exp-setting/molmo_spaces/env/mj_extensions.py:10)
  - 暴露了 `light_names / light_name2id / light_id2name`
- [lighting.py](/home/user/ldl/molmospaces-exp-setting/molmo_spaces/env/arena/randomization/lighting.py:377)
...
`task.step()` 的入口见 [task.py](/home/user/ldl/molmospaces-exp-setting/molmo_spaces/tasks/task.py:252)。
...
- `done: True/False`
  - [task.py](/home/user/ldl/molmospaces-exp-setting/molmo_spaces/tasks/task.py:323) 会先把它剥掉，再记录 `_done_action_received`
...
见 [astar_planner_policy.py](/home/user/ldl/molmospaces-exp-setting/molmo_spaces/policy/solvers/navigation/astar_planner_policy.py:482)：
...
见 [opening_solver.py](/home/user/ldl/molmospaces-exp-setting/molmo_spaces/policy/solvers/opening_solver.py:393)。
...
- [OpeningTask](/home/user/ldl/molmospaces-exp-setting/molmo_spaces/tasks/opening_tasks.py:18)
- [OpenClosePlannerPolicy](/home/user/ldl/molmospaces-exp-setting/molmo_spaces/policy/solvers/object_manipulation/open_close_planner_policy.py:18)
...
见 [explore_molmo_interactions.py](/home/user/ldl/molmospaces-exp-setting/scripts/InteractiveNav/explore_molmo_interactions.py:1)。
