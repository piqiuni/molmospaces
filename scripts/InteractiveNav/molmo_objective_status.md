...
- [explore_molmo_interactions.py](/home/user/ldl/molmospaces-exp-setting/scripts/InteractiveNav/explore_molmo_interactions.py:1)
  - `inspect-scene`
  - `set-articulation`
  - `action-schema`
  - `integration-recipe`
  - `env-check`
- [molmo_interaction_interfaces.md](/home/user/ldl/molmospaces-exp-setting/scripts/InteractiveNav/molmo_interaction_interfaces.md:1)
- [molmo_gt_workflow.md](/home/user/ldl/molmospaces-exp-setting/scripts/InteractiveNav/molmo_gt_workflow.md:1)
- [TODO.md](/home/user/ldl/molmospaces-exp-setting/TODO.md:287)
...
- [explore_molmo_interactions.py](/home/user/ldl/molmospaces-exp-setting/scripts/InteractiveNav/explore_molmo_interactions.py:609)
  - `nav-gt`
- [molmo_interaction_interfaces.md](/home/user/ldl/molmospaces-exp-setting/scripts/InteractiveNav/molmo_interaction_interfaces.md:1)
- [molmo_gt_workflow.md](/home/user/ldl/molmospaces-exp-setting/scripts/InteractiveNav/molmo_gt_workflow.md:1)
...
- [explore_molmo_interactions.py](/home/user/ldl/molmospaces-exp-setting/scripts/InteractiveNav/explore_molmo_interactions.py:636)
  - `door-path-study`
- live map 重建逻辑已写入同脚本
...
1. 默认资源缓存目录不可写
   - `molmospaces_resources` 默认尝试写 `/home/user/.cache/molmo-spaces-resources/.lock`
