...
class AblationConfig:
    ...
    def __post_init__(self) -> None:
        allowed = {"module1": {"static_semantic", "dynamic_rule", "dynamic_mllm"}, "module2": {"rule_cost", "mllm_score"}, "module3": {"direct_atomic", "rule_verified", "mllm_skill_verified"}}
    ...
    def uses_mllm(self) -> bool:
        return any(str(v).endswith("_mllm") or str(v).startswith("mllm_") for v in (self.module1, self.module2, self.module3))
