    ...
    def render(self) -> bytes:
        ...
        if isinstance(topology_graph, dict):
            ...
            for node in list(topology_graph.get("nodes") or []):
                ...
                if any(marker in node_text for marker in ("fridge", "refrigerator")):
                    filtered_nodes.append(node)
