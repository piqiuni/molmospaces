...
from ablations import BASELINE_COMMIT, VARIANTS
...
def main(argv=None):
    ...
    artifacts = render_artifacts(baseline.REPO, directory, args.variant, config["python_bin"])
    if args.variant != "full":
        command += ["--runner", str(runner_path(baseline.REPO, directory, args.variant))]
    manifest = {"variant": args.variant, "reference_baseline_commit": BASELINE_COMMIT,
