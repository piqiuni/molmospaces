#ifndef _VORONOI_MAPPING_H_
#define _VORONOI_MAPPING_H_
...
//! A VoronoiMapping object computes and updates a distance map and Voronoi diagram.
...
public:
  ...
  //! set the obstacle distance threshold for Voronoi point generation (in grid cells)
  void setObstacleDistanceThreshold(int threshold) { obstacle_distance_threshold_ = threshold; }
...
private:  
  ...
  int obstacle_distance_threshold_;  // 障碍物距离阈值（grid cells），用于控制Voronoi点生成
