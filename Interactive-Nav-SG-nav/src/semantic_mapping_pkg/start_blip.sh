...
gnome-terminal --title="BLIP SSH Tunnel" -- bash -c "ssh -L 5000:localhost:5000 wxy@10.106.11.248 'source ~/miniconda3/etc/profile.d/conda.sh && conda activate blip && cd ~/blip_server && bash start_server.sh'; exec bash"
