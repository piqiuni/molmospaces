...
categories_map = {}
categories_doors = []
with open(os.path.join(project_root, 'tools/matterport_category_mappings.tsv')) as file:
...
with gzip.open(os.path.join(project_root, "tools/val.json.gz"), 'r') as fin:        # 4. gzip
