  ...
  */
   ...
   */
    ...
    */
    ...
    void setUseOdometryPose(bool enabled) {m_useOdometryPose=enabled;}
    void setScanMatchingCorrectionLimits(bool lockYaw, double maxTranslation) {
      m_lockScanMatchingYaw=lockYaw;
      m_maxScanMatchingTranslationCorrection=maxTranslation;
    }
  ...
  protected:
    ...
    bool m_useOdometryPose;
    bool m_lockScanMatchingYaw;
    double m_maxScanMatchingTranslationCorrection;
