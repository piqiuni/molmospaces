    ...
    def build_request(
        ...
        if self.config.selection_granularity.casefold() == "room":
            ...
            instruction = (
                ...
                "(3) an executable INTERACT candidate for an observed door or fridge when it is not already "
                "completed or terminal-failed; interaction changes connectivity or reveals contents and must "
                "be preferred over ordinary EXPLORE frontiers; (4) NEXT_ROUTE_PORTAL before a remote container or frontier because it opens the observed "
                "topological route; (5) TARGET_CONTAINER or a semantically plausible container; "
                "(6) an eligible frontier with room_status=unentered_new_room when its room_target_affinity "
