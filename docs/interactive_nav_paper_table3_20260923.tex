% Historical v3 Table 3, before normalized Cost and per-attempt physical-effect IP.
% Do not pair these numbers with the new definitions in interactive_navigation_metrics_v4.tex.
